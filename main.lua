...
function init()
  ...
  passive_descriptions = {
    ...
    ['annihilation'] = '[fg]when a voider dies deal its DoT damage to all enemies for [yellow]30[fg] seconds',
    ['malediction'] = '[yellow]+1/3/5[fg] max curse targets to all allied cursers',
    ['hextouch'] = '[fg]enemies take [yellow]10/15/20[fg]% rndunitdps for [yellow]3[fg] seconds when cursed',
    ...
    ['meat_shield'] = '[fg]bigger critters always [yellow]block[fg] enemy projectiles',
    ['hive'] = '[fg]critters have [yellow]+50/100/150[fg]% HP and dmg',
    ['baneling_burst'] = '[fg]critters deal [yellow]25/50/75[fg]% AoE damage on hit and double that on death',
  ...
  passive_descriptions_level = {
    ...
    ['annihilation'] = function(lvl) return '[fg]when a voider dies deal its DoT damage to all enemies for [yellow]30[fg] seconds' end,
    ['malediction'] = function(lvl) return ts(lvl, '+1', '3', '5') .. ' max curse targets to all allied cursers' end,
    ['hextouch'] = function(lvl) return '[fg]enemies take ' .. ts(lvl, '10', '15', '20') .. '% rndunitdps for [yellow]3[fg] seconds when cursed' end,
